import React, { useReducer, useEffect, useCallback, useRef, Suspense, useState } from 'react';
...
const PipelineBoard = lazyScreen(() => import('./crm/PipelineBoard'));
const ContactList = lazyScreen(() => import('./crm/ContactList'));
const ContactDetail = lazyScreen(() => import('./crm/ContactDetail'));
const CommunicationHub = lazyScreen(() => import('./crm/CommunicationHub'));
const CalendarView = lazyScreen(() => import('./crm/CalendarView'));
const DocumentCenter = lazyScreen(() => import('./crm/DocumentCenter'));
const FinancialDashboard = lazyScreen(() => import('./crm/FinancialDashboard'));
const InvoicesPage = lazyScreen(() => import('./crm/InvoicesPage'));
const TeamView = lazyScreen(() => import('./crm/TeamView'));
const AutomationsView = lazyScreen(() => import('./crm/AutomationsView'));
const SettingsView = lazyScreen(() => import('./crm/SettingsView'));
const AIAssistant = lazyScreen(() => import('./crm/AIAssistant'));
const SuppliersView = lazyScreen(() => import('./crm/SuppliersView'));
const QuotesView = lazyScreen(() => import('./crm/QuotesView'));
const StormSearchView = lazyScreen(() => import('./crm/StormSearchView'));
const ProjectsView = lazyScreen(() => import('./crm/ProjectsView'));
const WorkOrdersView = lazyScreen(() => import('./crm/WorkOrdersView'));
const MaterialOrdersView = lazyScreen(() => import('./crm/MaterialOrdersView'));
const ExpenseTracker = lazyScreen(() => import('./crm/ExpenseTracker'));
const DocumentTemplates = lazyScreen(() => import('./crm/DocumentTemplates'));
const ReportsAnalytics = lazyScreen(() => import('./crm/ReportsAnalytics'));
const SalesAnalytics = lazyScreen(() => import('./crm/SalesAnalytics'));
const InsuranceTrackingView = lazyScreen(() => import('./crm/InsuranceTrackingView'));
const SupplementTrackingView = lazyScreen(() => import('./crm/SupplementTrackingView'));
const CrewScheduleView = lazyScreen(() => import('./crm/CrewScheduleView'));
const EquipmentView = lazyScreen(() => import('./crm/EquipmentView'));
const CommissionPayrollView = lazyScreen(() => import('./crm/CommissionPayrollView'));
const InspectionsView = lazyScreen(() => import('./crm/InspectionsView'));
