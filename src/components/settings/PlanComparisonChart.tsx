...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Work Orders (Multi-Trade Support)', values: [Y, Y, Y, P('Basic')] },
      { feature: '17 Job Types (Roofing, Exterior, Interior)', values: [Y, N, N, N] },
      { feature: 'Subcontractor Assignment & Cost Tracking', values: [Y, P('Limited'), P('Limited'), N] },
      { feature: 'Change Orders (AWO) Built-In', values: [Y, N, P('Limited'), N] },
      { feature: 'Dynamic Job Specifications (by type)', values: [Y, N, N, N] },
      { feature: 'Ready to Invoice Status', values: [Y, N, N, N] },
  ...
  },
  {
    ...
    defaultOpen: false,
    rows: [
      { feature: 'Document Templates (Professional)', values: [Y, Y, Y, Y] },
      ...
      { feature: 'Change Order Template', values: [Y, N, P('Manual'), N] },
      { feature: 'Certificate of Completion Template', values: [Y, P('Limited'), P('Limited'), N] },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Expense Tracking (13 Categories)', values: [Y, P('Limited'), P('Limited'), N] },
      { feature: 'Separate Labor vs Sub Costs', values: [Y, N, P('Limited'), N] },
      { feature: 'Profit Margin Calculations', values: [Y, P('Limited'), Y, N] },
      { feature: 'QuickBooks Integration', values: [Y, Y, Y, P('Limited')] },
      { feature: 'Supplier Management (8 Pre-loaded)', values: [Y, P('Basic'), Y, P('Limited')] },
      { feature: 'Excel Export (35+ columns)', values: [Y, P('Limited'), P('Limited'), N] },
