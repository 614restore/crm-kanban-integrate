...
const SECTIONS: Section[] = [
  {
    ...
    rows: [
      ...
      { feature: '10-User Real-World Cost',            values: ['$99/mo', P('$275/mo'), P('$399/mo'), P('$299/mo'), P('$249/mo'), P('$598/mo+')] },
      { feature: 'Unlimited Users Tier Available',     values: [Y, P('$350+'), P('Custom'), P('Custom'), Y, P('Custom')] },
      ...
      { feature: 'Annual Discount',                    values: [Y, Y, P('Custom'), Y, Y, N] },
    ],
  },
  {
    id: 'crm',
...
const WHY_WIN = [
  ...
  { val: 'Web + Mobile', desc: 'Native Flutter mobile app + web platform included in every plan' },
