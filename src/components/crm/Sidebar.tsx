...
const navItems: NavItem[] = [
  ...
  { id: 'time-tracking', label: 'Time Tracking', icon: <CalendarClock size={20} />, requiresPermission: 'team' },
  { id: 'job-map', label: 'Job Map', icon: <LayoutDashboard size={20} /> },
  { id: 'storm-alerts', label: 'Storm Alerts', icon: <AlertCircle size={20} /> },
