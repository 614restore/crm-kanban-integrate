...
const STAGES: StageConfig[] = [
  ...
  { statuses: ['inspected', 'inspection_complete', 'inspection_completed'], label: 'Inspection', color: 'bg-amber-500' },
  { statuses: ['estimating', 'supplement_filed'], label: 'Estimating', color: 'bg-yellow-500' },
  { statuses: ['estimate_sent', 'contingency'], label: 'Follow Up / Negotiating', color: 'bg-orange-500' },
  { statuses: ['approved', 'signed', 'signed_won'], label: 'Sold', color: 'bg-emerald-500' },
  { statuses: ['ordering_material'], label: 'Ordering Materials', color: 'bg-cyan-500' },
  { statuses: ['scheduled'], label: 'Scheduled', color: 'bg-teal-500' },
  { statuses: ['in_progress', 'build_phase'], label: 'In Progress', color: 'bg-primary' },
  { statuses: ['cleanup'], label: 'Cleanup', color: 'bg-lime-500' },
