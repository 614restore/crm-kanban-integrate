...
${footer}`,
    ...
    // ── 1. Asphalt Shingle Roof Replacement ──────────────────────────────
    {
      ...
      fields: [
        ...
        { key: 'ICE_WATER_TOTAL', label: 'Ice & Water Total', type: 'text', defaultValue: '$150.00', required: true },
      ...
      lineItemDefaults: [
        ...
        { description: 'Ice & water shield', qty: '1', unit: 'rolls', unitPrice: 150, total: 150 },
...
export function buildContactOverrides(
  ...
  const defaults: Record<string, string> = {
    ...
    ICE_WATER_SQ: '1',                // Rolls of ice & water shield
    ICE_WATER_RATE: '$150.00',        // Cost per roll for ice & water
    ICE_WATER_TOTAL: '$150.00',       // 1 roll × $150
